...
export class NavContentComponent implements OnInit, AfterViewInit {
  ...
  constructor(public nav: NavigationItem, private zone: NgZone, private location: Location,public navigations:NavigationItem ) {
  ...
  // menuItems: MenuItem[] = [];
  ngOnInit() {
     // get the user role from the authentication service or from a route data
    // const role = 'admin'; // hardcoded for demo purposes
    // this.menuItems = this.navigations.getMenuItems(role);
